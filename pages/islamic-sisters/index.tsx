...
export const getStaticProps: GetStaticProps<{
    ...
    try {
        const { data } = await getAllBlogs(1, 6, 'islamic-sister', envData)
...
const IslamicSister = ({
    ...
    async function getMore() {
        ...
        try {
            ...
            discordLog(
                `Error: Get More Islamic Sister API with a message "${error.message}"`,
    ...
    return (
        <>
            <HeadTag
                seoTitle={'Islamic Sisters'}
                seoDescription={''}
                seoURL={'/islamic-sisters'}
            />
            <Nav env={env} />
